...
public class FirstAud {
    ...
    private static class ErrorCounterTask extends Thread {
        ...
        public void run() {
            try {
                long errorCount = Files.lines(file)
                        .filter(line -> line.contains("ERROR"))
                        .count();
                lock.lock();
                total += errorCount;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path logsDir = Paths.get("C:\\Users\\Mary\\IdeaProjects\\AP\\src\\AUD9_MultiThreading\\filesAud1"); // <-- adjust if needed
