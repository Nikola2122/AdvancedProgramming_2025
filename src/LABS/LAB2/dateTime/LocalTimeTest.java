...
public class LocalTimeTest {
    ...
    static LocalTime localTimeOfHourToNanoSec() {
        return LocalTime.of(23, 7, 3, 100_000_000).plus(3, ChronoUnit.MILLIS);
    }

    static LocalTime localTimeParse() {
        return LocalTime.parse("23:07:03,1".replace(",","."));
    }
    ...
    static class DateAndTimes {
        public static final LocalTime LT_23073050 =
                LocalTime.of(23, 7, 30, 500_000_000);

        public static final LocalTime LT_12100000 =
                LocalTime.of(12, 10);
    }
}
